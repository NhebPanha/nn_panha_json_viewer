import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, nextTick, onScopeDispose, watch, toRefs, computed, defineComponent, createElementBlock, provide, cloneVNode, h, toValue, onServerPrefetch, unref, defineAsyncComponent, Suspense, mergeProps, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "D:/Assignment/nn_viewer/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/Assignment/nn_viewer/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/Assignment/nn_viewer/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/Assignment/nn_viewer/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "D:/Assignment/nn_viewer/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "D:/Assignment/nn_viewer/node_modules/ufo/dist/index.mjs";
import { debounce } from "D:/Assignment/nn_viewer/node_modules/perfect-debounce/dist/index.mjs";
import { hash } from "D:/Assignment/nn_viewer/node_modules/ohash/dist/index.mjs";
import { isPlainObject as isPlainObject$1 } from "@vue/shared";
import "D:/Assignment/nn_viewer/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "D:/Assignment/nn_viewer/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DQ0E6V17.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-C2I5zElM.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-B2HjbHZv.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DHsTXydA.js"));
