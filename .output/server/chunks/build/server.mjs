import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { toRef, isRef, hasInjectionContext, getCurrentInstance, inject, ref, reactive, effectScope, isReactive, toRaw, getCurrentScope, onScopeDispose, watch, nextTick, toRefs, markRaw, computed, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, mergeProps, withCtx, isReadonly, toValue, useSSRContext, isShallow } from 'vue';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DQ0E6V17.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-C2I5zElM.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B2HjbHZv.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DHsTXydA.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useHead as d, entry_default as default, encodeRoutePath as e, defineStore as f, useState as g, navigateTo as n, resolveRouteObject as r, useRouter as u };
