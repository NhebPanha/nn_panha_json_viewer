...
<template>
  <div class="editor-shell relative w-full h-full min-h-[560px] border border-t-0 border-slate-200 dark:border-slate-800 rounded-b-2xl overflow-hidden bg-white dark:bg-[#1e1e1e]">
    ...
    <!-- Monaco container -->
    <div ref="containerRef" class="monaco-host w-full h-[calc(100vh-300px)] min-h-[560px]"></div>
  </div>
</template>
